...
public class GuguSlimefunItemFactory {
    ...
    public static GuguSlimefunArmorPiece createItem(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, PotionEffect... potionEffects) {
